...
**NOTE: the latest Jailbreak firmware can now be found at the [analoguejb](https://github.com/analoguejb/Analogue-Mega-Sg-JB) GitHub page. If you have any issues, old or new, please open a ticket there.**
...
Extract everything to the root of your SD card and be sure to remove any existing firmware file. Place BIOS files in the BIOS directory. Insert the card into your Mega Sg and power
...
An empty folder structure is included.
...
## Changelog
- [JB7.9](https://github.com/analoguejb/Analogue-Mega-Sg-JB/releases/download/v7.9/msg_firmware_verJB7.9.zip) 2023-06-24
